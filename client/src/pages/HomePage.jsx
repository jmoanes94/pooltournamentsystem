...
export function HomePage() {
  ...
  return (
    <div className="space-y-8 animate-slideIn">
      ...
      <div className="rounded-2xl border border-white/10 bg-gradient-to-r from-slate-900/80 to-slate-950/80 px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
      ...
      {status && (
        <div className={`rounded-2xl border px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 ${toneStyles}`}>
          <div>
